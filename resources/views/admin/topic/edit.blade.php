...
@section('title','EDIT POST|TravelMe')

@section('content')
<section class="section-inner">
  <h1 class="post-ttl">EDIT POST</h1>
      ...
      <div class="left-container">
        <table class="post-table">
          <tr class="post-row">
            ...
            <td class="post-data"><input type="text" class="form-control" name="title" value="{{ $topic_form->title }}"></td>
          </tr>
          <tr class="post-row">
            <th class="post-head">LOCATION</th>
            <td class="post-data">
              <select name="location">
                <option value="Hokkaido" {{ $topic_form->location }}>北海道</option>
          ...
          <tr class="post-row">
            <th class="post-head">GENRE</th>
              <td class="post-data">
                <div class="genre">
                  <input type="checkbox" id="spot" name="genre[]" value="{{ $topic_form->genre }}">
          ...
          <tr class="post-row">
            ...
            <td class="post-data">
              <textarea name="body" rows="20">{{ $topic_form->body }}</textarea>
            </td>
          </tr>
        </table>
      </div>  
        ...
        <table class="post-table">
          <tr class="post-row">
            ...
            <td class="post-data">
              ...
              <p>設定中: {{ $topic_form->image_path }}</p>
              <label class="form-check-label">
                <input type="checkbox" class="form-check-input" name="remove" value="true">Delete Picture
              </label>
            </td>
          </tr>
        </table>
